...
def highs_standard_genetics(
    ...
    Step h:
        ...
        Then compute reduced costs for inactive variables using the full
        KKT condition. If all inactive reduced costs are non-positive, stop.
        Otherwise add variables with positive reduced cost to N_h.
    """
    ...
    for iteration in range(max_iterations):
        ...
        # Gradient of the original full-dimensional maximization objective:
        #
        #     grad = mu - lambda * Sigma w
        #
        # HiGHS solves the negated minimization problem, so its row_dual has
        # the opposite sign from the maximization multiplier y.
        #
        # Therefore, using HiGHS row_dual:
        #
        #     reduced_cost_i = grad_i + row_dual[group(i)]
        #
        ...
        # Stop when all inactive variables have non-positive reduced cost.
